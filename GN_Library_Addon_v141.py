...
def gn_userlib_category1_name(context):
    preferences = context.preferences
    addon_prefs = preferences.addons[__name__].preferences
    dirname = addon_prefs.categoryname
    return dirname
...
def update_categoryName(self, context):
    message_good = ": Category Name has updated"
    message = ": Updating Category Name has failed"
    
    try:
        bpy.utils.unregister_class(NODE_MT_ButtonsSub_cat1)
    
        NODE_MT_ButtonsSub_cat1.bl_label = context.preferences.addons[__name__].preferences.categoryname
    
        bpy.utils.register_class(NODE_MT_ButtonsSub_cat1)
...
def update_categoryName2(self, context):
    message_good = ": Category 2 Name has updated"
    message = ": Updating Category 2 Name has failed"
    
    try:
        bpy.utils.unregister_class(NODE_MT_ButtonsSub_cat2)
    
        NODE_MT_ButtonsSub_cat2.bl_label = context.preferences.addons[__name__].preferences.categoryname2
    
        bpy.utils.register_class(NODE_MT_ButtonsSub_cat2)
...
def update_categoryName3(self, context):
    message_good = ": Category 3 Name has updated"
    message = ": Updating Category 3 Name has failed"
    
    try:
        bpy.utils.unregister_class(NODE_MT_ButtonsSub_cat3)
    
        NODE_MT_ButtonsSub_cat3.bl_label = context.preferences.addons[__name__].preferences.categoryname3
    
        bpy.utils.register_class(NODE_MT_ButtonsSub_cat3)
...
def update_categoryPro1(self, context):
    message_good = ": Category Project Name has updated"
    message = ": Updating Category Project Name has failed"
    
    try:
        bpy.utils.unregister_class(NODE_MT_ButtonsSub_pro1)
    
        NODE_MT_ButtonsSub_pro1.bl_label = context.preferences.addons[__name__].preferences.categorynamepro1
    
        bpy.utils.register_class(NODE_MT_ButtonsSub_pro1)
...
class GnNodeLibraryPrefs(AddonPreferences):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.label(text="INFO: v1.4.1",icon="INFO")
...
class NODE_MT_ButtonsSub_cat1(bpy.types.Menu):
    bl_label = 'Generators'
    bl_idname = 'NODE_MT_librarysubmenu'
    bl_description = "First presets category"
    bl_icon='NODETREE'
...
class NODE_MT_ButtonsSub_cat2(bpy.types.Menu):
    bl_label = 'Transform'
    bl_idname = 'NODE_MT_librarysubmenu2'
    bl_description = "Presets category 2"
    bl_icon='NODETREE'
...
class NODE_MT_ButtonsSub_cat3(bpy.types.Menu):
    bl_label = 'Math'
    bl_idname = 'NODE_MT_librarysubmenu3'
    bl_description = "Presets category 3"
    bl_icon='NODETREE'
...
class NODE_MT_ButtonsSub_pro1(bpy.types.Menu):
    bl_label = 'Project'
    bl_idname = 'NODE_MT_librarysubmenupro1'
    bl_description = "Presets category project"
    bl_icon='NODETREE'
